...
# 10/12 Don't skip by scale factor only by 5 and start at the end of the green shirt
# 10/12 Retype the entire code with some calculations changed to make it more efficient 
# 10/12 While checking conditions skip if out of bounds
# 10/12 Stop checking out of bounds at the top
...
IndLoop:    lb $10, Array($4)        #load current byte
